...
import { Settings, LogOut, Store, ChevronRight, CreditCard, Bell, Loader2 } from "lucide-react"
...
function ProfilePage() {
  ...
  // Generate user initials for avatar (e.g., "John Doe" → "JD")
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 pb-24 lg:pb-8">
      ...
      <div className="p-4 md:p-8 max-w-2xl md:max-w-4xl lg:max-w-6xl mx-auto space-y-6">
        {/* User profile card - Shows avatar, name, email, and edit link */}
        ...
        {/* Vendor Mode Card - Switch to store management dashboard */}
        <div
        ...
        {/* Settings cards - Notification, payments, and account preferences */}
