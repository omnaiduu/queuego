...
const STORES = [
  {
    ...
    reviews: 124,
    distance: "0.8 km",
    image: "/modern-dental-clinic-interior-bright-clean.jpg",
    isOpen: true,
    waitTime: 35,
  },
  {
    ...
    reviews: 89,
    distance: "1.2 km",
    image: "/barber-shop-interior.jpg",
    isOpen: true,
    waitTime: 15,
  },
  {
...
export default function HomePage() {
  ...
  const [hasActiveTicket, setHasActiveTicket] = useState(true) // Simulate active ticket
