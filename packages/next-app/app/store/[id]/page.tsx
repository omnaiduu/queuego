...
export default function StoreDetailPage() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      // Randomly fluctuate wait time slightly to simulate "live" data
    ...
    <div className="min-h-screen bg-background pb-24 lg:pb-0 relative">
      <div className="max-w-md md:max-w-2xl lg:max-w-6xl mx-auto relative lg:mt-20">
        ...
        <header className="relative h-[35vh] lg:h-[40vh] w-full">
          <Image
            src="/modern-dental-clinic-interior-bright-clean.jpg"
            alt="Store Hero"
            fill
        ...
        <div className="px-5 lg:px-8 pt-8 space-y-8">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold text-zinc-900 dark:text-white leading-tight">Dr. Smith Dental Clinic</h1>
            <div className="flex items-center gap-2 text-sm text-zinc-500">
              <span className="font-medium text-zinc-900 dark:text-zinc-200">Medical</span>
              <span>•</span>
              ...
              <div className="flex items-center gap-1 text-amber-500">
                ...
                <span className="text-zinc-400 font-normal">(124)</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-xl p-4 space-y-3 divide-y divide-zinc-200 dark:divide-zinc-700">
                {/* Sample services - replace with dynamic data */}
                {[
